<?php
 ...
 //print_r($_GET); //displaying all content submitted in the form using the GET method
  ...
  if (isset($_GET['keyword']) && (!empty($_GET['keyword']) || !empty($_GET['layout']))) { //if form was submitted
      
      include 'api/pixabayAPI.php';
      if(isset($_GET['category']) && !empty($_GET['category'])){
        echo "<h3>You searched for: " . $_GET['category'] . "</h3>";
      }elseif (isset($_GET['layout'])) {
        echo "<h3>You searched for a picture with: " . $_GET['layout'] . " layout</h3>";
...
<html>
    ...
    <body>
        ...
        <?php
            ...
            }  elseif (empty($_GET['keyword']) && empty($_GET['layout'])) {
                echo "<h2> You must type a keyword or select a category </h2>";
            }
        ?>
        ...
        <form method="GET">
            ...
            <select name="category">
              ...
              <option <?=checkCategory('Moon')?>>  Moon </option>
              <option <?=checkCategory('Beach')?>>  Beach </option>
        ...
        <?php
           ...
           if (!empty($_GET['keyword']) || !empty($_GET['layout'])) {
        ?>
